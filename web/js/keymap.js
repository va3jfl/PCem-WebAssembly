// ============================================================================
// keymap.js — KeyboardEvent.code -> XT set-1 scancode index into pcem_key[].
// Extended (E0-prefixed) keys use the native PCem convention: code | 0x80.
// ============================================================================

const E = 0x80; // extended flag
...
export const SCAN_LCONTROL = 0x1d;
export const SCAN_END = 0x4f | E;
