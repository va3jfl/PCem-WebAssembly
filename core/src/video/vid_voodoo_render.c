...
#elif defined __EMSCRIPTEN__ && !defined(NO_VOODOO_CODEGEN)
/* PCem-web: runtime wasm span recompiler (see the header). */
#include "vid_voodoo_codegen_wasm.h"
#define VOODOO_WASM_CODEGEN
#else
int voodoo_recomp = 0;
#endif
...
static void voodoo_half_triangle(voodoo_t *voodoo, voodoo_params_t *params, voodoo_state_t *state, int ystart, int yend,
        ...
        int texels;
        int c;
#if !defined(NO_CODEGEN) || defined(VOODOO_WASM_CODEGEN)
