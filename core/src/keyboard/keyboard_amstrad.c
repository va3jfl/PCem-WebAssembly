...
static void keyboard_amstrad_poll_timer_cb(void *priv) {
        (void)priv;
        keyboard_amstrad_poll();
}
...
void keyboard_amstrad_init() {
        ...
        timer_add(&keyboard_amstrad.send_delay_timer, keyboard_amstrad_poll_timer_cb, NULL, 1);
}
