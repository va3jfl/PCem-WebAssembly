...
static void keyboard_olim24_poll_timer_cb(void *priv) {
        (void)priv;
        keyboard_olim24_poll();
}
...
void keyboard_olim24_init() {
        ...
        timer_add(&keyboard_olim24.send_delay_timer, keyboard_olim24_poll_timer_cb, NULL, 1);
}
