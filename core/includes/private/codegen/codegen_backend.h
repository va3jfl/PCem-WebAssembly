...
/* PCem-web: no runtime code generation in WebAssembly — interpreter only.
   See wasm/shim/codegen_backend_wasm.h and wasm/platform/wasm-codegen-stub.c. */
#include "codegen_backend_wasm.h"
#else
